<?php
	$recent = \App\Models\InfoProductLastView::select('StoreProductID')
	->where('CustomerID','=',\Auth::user()->id)
	->groupBy('StoreProductID','CustomerID')->limit(10)->get();
?>
@if($recent->count() > 3)
	<div class="viewed">
			<div class="container">
				<div class="row">
					<div class="col">
						...
						<div class="viewed_slider_container">
							...
							<div class="owl-carousel owl-theme viewed_slider" id="recentViewed">
								
								<!-- Recently Viewed Item -->
								<?php
									$data = \App\Models\InfoProductLastView::select('StoreProductID')
									->where('CustomerID','=',\Auth::user()->id)
									->groupBy('StoreProductID','CustomerID')->limit(10)->get();
									...
									<div class="owl-item">
										<div class="viewed_item discount d-flex flex-column align-items-center justify-content-center text-center">
											...
											<div class="viewed_content text-center">
												<div class="viewed_price" style="color: #008080;">
													Rp. {{ str_replace(',','.',number_format($dt->produk->PriceFrom,0)) }}
												</div>
