...
<div class="box">
	<div class="box-body">
		...
		<form method="post" action="{{ url('admin/warna/tambah') }}">
			{{ csrf_field() }}
		  <div class="form-group">
		    <label for="exampleInputEmail1">Nama</label>
		    <input type="text" name="nama" value="{{ old('nama') }}" class="form-control" id="exampleInputEmail1" placeholder="Nama Warna">
		  </div>
		  <div class="form-group">
		    <label for="exampleInputPassword1">Kode Warna</label>
		    <input type="text" name="kode" value="{{ old('kode') }}" class="form-control" id="exampleInputPassword1" placeholder="Kode Warna">
		  </div>
